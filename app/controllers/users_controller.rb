class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:email, :password, :password_confirmation, :quality_of_life, :name, :date_completed, :person_helping, :mpoa, :mpoa_name, :review_with_mpoa, :surrogate)
    end
end
